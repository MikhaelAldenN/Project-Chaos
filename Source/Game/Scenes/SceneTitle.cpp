...
void SceneTitle::Render(float dt, Camera * targetCamera)
{
    ...
    if (logoSprite)
    {
        logoSprite->Render(dc, 421.5f, 200.0f, 0.0f, 997.0f, 547.0f, 0.0f, 0.0f, 997.0f, 547.0f, 0.0f, 1.0f, 1.0f, 1.0f, bootAlpha);
    }
    ...
    {
        copyrightSprite->Render(dc, 287.5f, 867.0f, 0.0f, 1265.0f, 105.0f, 0.0f, 0.0f, 1265.0f, 105.0f, 0.0f, 1.0f, 1.0f, 1.0f, finalCopyrightAlpha);
    }

    // RENDER START
    if (startSprite && m_startAlpha > 0.0f)
    {
        startSprite->Render(dc, 699.5f, 906.5f, 0.0f, 441.0f, 26.0f, 0.0f, 0.0f, 441.0f, 26.0f, 0.0f, 1.0f, 1.0f, 1.0f, m_startAlpha);
    }
