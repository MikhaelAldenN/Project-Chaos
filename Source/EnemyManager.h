...
namespace EnemyLevelData
{
    ...
    {
        // Paddle 1 
        { { 10.0f, 0.0f, -28.0f }, { 0.0f, -1.6f, 0.0f }, Blue, EnemyType::Paddle },

        // Paddle 2
        { { -10.0f, 0.0f, -40.0f }, { 0.0f, 1.6f, 0.0f }, Blue, EnemyType::Paddle },

        // Paddle 3
        { { 0.0f, 0.0f, -50.0f }, { 0.0f, 0.0f, 0.0f }, Blue, EnemyType::Paddle },

        // Paddle 4
        { { 0.0f, 0.0f, -65.5f }, { 0.0f, 0.0f, 0.0f }, Blue, EnemyType::Paddle },

        // Paddle 5
        { { 0.0f, 0.0f, -79.1f }, { 0.0f, 0.0f, 0.0f }, Blue, EnemyType::Paddle },

        // Paddle 6
        { { 0.0f, 0.0f, -146.8f }, { 0.0f, 0.0f, 0.0f }, Blue, EnemyType::Paddle },

        // Paddle 7
        { { -6.5f, 0.0f, -151.6f }, { 0.0f, 0.0f, 0.0f }, Blue, EnemyType::Paddle },
        ...
        // Paddle 11
        { { 0.0f, 0.0f, -189.0f }, { 0.0f, 0.0f, 0.0f }, Blue, EnemyType::Paddle },
        ...
        // Paddle 16
        { { -9.5f, 0.0f, -280.0f }, { 0.0f, 1.6f, 0.0f }, Blue, EnemyType::Paddle },

        // Paddle 17
        { { -9.5f, 0.0f, -289.5f }, { 0.0f, 1.6f, 0.0f }, Blue, EnemyType::Paddle },
    };
}
